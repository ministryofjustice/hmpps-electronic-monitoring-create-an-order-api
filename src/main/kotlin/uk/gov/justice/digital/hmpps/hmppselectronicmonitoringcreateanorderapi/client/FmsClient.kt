...
class FmsClient(
  ...
  // TODO: Sort out null values
  // TODO: Sort out variation path
  fun createAttachment(fileName: String, caseId: UUID, file: InputStreamResource, documentType: String): FmsAttachmentResponse {
    val token = fmsAuthClient.getClientToken()
    val tableName = "x_serg2_ems_csm_sr_mo_new" // TODO: extract to config file + new vs variations decided at service level?
        ...
        it.bodyToMono(FmsErrorResponse::class.java).flatMap { error ->
          Mono.error(
            CreateSercoEntityException(
              ...
              //TODO: when you swap out orderId for correct ID, this line will need to be updated ^^
              //TODO: documentType for exclusion/inclusion zone
            ),
          )
        }
      })
