    ...
    inner class CreateVersionAsVariation {
      ...
      fun `It should clone interestedParties referencing new version and clear notifying organisation data`() {
        argumentCaptor<Order>().apply {
          ...
          assertThat(firstValue.versions.last().interestedParties?.notifyingOrganisation).isEmpty()
          assertThat(firstValue.versions.last().interestedParties?.notifyingOrganisationName).isEmpty()
          assertThat(firstValue.versions.last().interestedParties?.notifyingOrganisationEmail).isEmpty()
